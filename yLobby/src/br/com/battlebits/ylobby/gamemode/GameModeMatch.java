...
public abstract class GameModeMatch extends GameModeBase {
	...
	public GameModeMatch(final String servername, String serverdescription, Material iconmaterial, Location npclocation, CharacterType characterType,
			final BungeeMessage connectMessage) {
		super(servername, serverdescription, iconmaterial, Arrays.asList("§b§lClique esquerdo §bpara ", "§b§lconectar §ba um §b§lservidor§b.", "§0",
				"§e§lClique direito §epara ver", "§e§ltodos §eos §e§lservidores§e."), npclocation, characterType);
